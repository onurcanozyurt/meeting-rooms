...
function() {
    ...
    function i(t,
    e) {
        var n=t instanceof Date&&e instanceof Date, o=t<e;
        return n&&o
    }
    function a(t,
    e) {
    ...
    Timetable.prototype= {
        ...
        a) {
            ...
            return this.events.push( {
                name: t, location: e, startDate: n, endDate: o, options: c?a: void 0
            }
            ),
            this
        }
    ...
    Timetable.Renderer.prototype= {
        draw: function(t) {
            ...
            function n(t) {
                var e=t.appendChild(document.createElement("aside")), n=e.appendChild(document.createElement("ul"));
                o(n)
            }
            function o(t) {
                for(var e=0;
                e<f.locations.length;
                e++) {
                    var n=t.appendChild(document.createElement("li")), o=n.appendChild(document.createElement("span"));
                    o.className="row-heading", o.textContent=f.locations[e]
                }
            }
            function r(t) {
                var e=t.appendChild(document.createElement("section")), n=e.appendChild(document.createElement("time"));
                i(n), l(n)
            }
            function i(t) {
                for(var e=t.appendChild(document.createElement("header")), n=e.appendChild(document.createElement("ul")), o=!1, r=!1, i=f.scope.hourStart;
                !o;
                ) {
                    var a=n.appendChild(document.createElement("li")), c=a.appendChild(document.createElement("span"));
            ...
            function d(t,
            e) {
                var n, o, r=void 0!==t.options, i=!1;
                r&&(n=void 0!==t.options.url, o=void 0!==t.options["class"], i=void 0!==t.options.data);
                var a=n?"a": "span", c=e.appendChild(document.createElement(a)), s=c.appendChild(document.createElement("small"));
                if(c.title=t.name, n&&(c.href=t.options.url), i)for(var l in t.options.data)c.setAttribute("data-"+l, t.options.data[l]);
                c.className=o?"time-entry "+t.options["class"]: "time-entry", c.style.width=h(t), c.style.left=m(t), s.textContent=t.name
            }
            function h(t) {
                var e=t.startDate, n=t.endDate, o=p(e, n);
                return o/v*100+"%"
            }
            function p(t,
            e) {
            ...
            function m(t) {
                var e=f.scope.hourStart, n=t.startDate.getHours()+t.startDate.getMinutes()/60, o=a(e, n);
                return o/v*100+"%"
            }
            var f=this.timetable,
            v=a(f.scope.hourStart,
            f.scope.hourEnd),
